...
public class Mariadb {
    ...
    public void readDBClient(String nom, String prenom, String mdp, String mail, String pub, boolean sexe) throws SQLException {
        ...
        preparedStatement.setString(2, prenom);   // pr√©nom
    ...
    public void LogDB(String mail, String mdp) throws SQLException {
        ...
        preparedStatement.setString(2, mdp);   // pr√©nom
        resultSet = preparedStatement.executeQuery();
        while( resultSet.next()){
    ...
    public ArrayList<User> getPatient() throws SQLException {
    	...
    	Statement st = conn.createStatement();
    	 ...
    	 ResultSet prof ;
    	 //RÈcupÈre les data de la table client
    	 while(rs.next()) { 
    	  ...
    	  //RecupËre les datas de la table profession_client correspondant au client crÈÈ
    	  while(prof.next()) {
...
EXEMPLE POUR COMPRENDRE
    ...
    public void readDataBase() throws Exception {
        ...
        preparedStatement.setString(2, "Corinne");   // pr√©nom
